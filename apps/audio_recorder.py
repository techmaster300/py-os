...
class AudioRecorderApp(BlindApp):
    ...
    def run(self, file_path=None):
        ...
        self.stop_playback_btn = wx.Button(panel, label="Stop")
        ...
        vol_speed_row = wx.BoxSizer(wx.HORIZONTAL)
        ...
        self.vol_slider = wx.Slider(panel, value=100, minValue=0, maxValue=100, size=(120, -1))
        ...
        self.speed_choice = wx.Choice(panel, choices=["0.5x", "0.75x", "1.0x", "1.25x", "1.5x", "2.0x"])
